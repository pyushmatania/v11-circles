...
const ProjectDetailPage: React.FC<ProjectDetailPageProps> = ({ project, onClose, onInvest, initialTab = 'overview' }) => {
  ...
  const embedUrl = videoId ? `https://www.youtube.com/embed/${videoId}?autoplay=0&modestbranding=1&rel=0&showinfo=0&controls=1&enablejsapi=1&origin=${window.location.origin}` : null;
    ...
    >
      ...
      <div className="relative h-screen flex">
        ...
        <motion.div
          initial={{ x: -300 }}
          animate={{ x: 0 }}
          className="w-80 bg-gradient-to-b from-gray-900/95 to-black/95 backdrop-blur-xl border-r border-gray-800/50 overflow-y-auto"
        >
          <div className="p-6">
            {/* Close Button */}
        ...
        <div className="flex-1 overflow-y-auto">
              ...
              <div className="max-w-7xl mx-auto px-8 pb-16 w-full">
                ...
                >
                  ...
                  >
                    ...
                    {project.rating && (
                      <div className="flex items-center gap-1 px-3 py-2 rounded-full bg-yellow-500/20 text-yellow-300 text-sm font-bold border border-yellow-500/30">
                        <Star className="w-4 h-4 fill-current" />
                        {project.rating}
                      </div>
                    )}
                    <div className="flex items-center gap-1 px-3 py-2 rounded-full bg-red-500/20 text-red-300 text-sm font-bold border border-red-500/30">
                  ...
                  <motion.button
                    ...
                    className="group relative inline-flex items-center gap-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-6 px-12 rounded-2xl font-bold text-xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-2xl shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-105"
                  >
          ...
          {/* Content Sections */}
          <div className="relative z-10 bg-gradient-to-b from-gray-900 to-black min-h-screen">
